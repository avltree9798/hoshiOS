...
aarch64-elf-gcc -c lib/lib.s -o out/lib.o
...
aarch64-elf-gcc -std=c99 -ffreestanding -mgeneral-regs-only  -c lib/print.c -o out/print.o
...
aarch64-elf-gcc -std=c99 -ffreestanding -mgeneral-regs-only  -c lib/syscall.c  -o out/syscall.o
aarch64-elf-ld -nostdlib -T link.lds -o out/kernel out/boot.o out/main.o out/lib.o out/uart.o out/print.o out/debug.o out/handlera.o out/handler.o out/mmu.o out/memory.o out/file.o out/crypto.o out/process.o out/syscall.o
